...
ch_data = np.zeros((24,2048), dtype=int) + 128
...
ch_cond=ch_data.reshape((24,512,4))
...
ch_vals=np.zeros((24,512),dtype=int)
...
#for easier plotting
np.savetxt("data/processed_input_waveforms.txt",(ch_data),fmt="%i")
